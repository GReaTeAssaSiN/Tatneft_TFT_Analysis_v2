...
Три Streamlit-дашборда + два скрипта для прогнозирования продаж топлива и товаров магазина на АЗС с помощью **Temporal Fusion Transformer** (pytorch-forecasting). Учебный проект (магистратура КАИ, ТАБД).
